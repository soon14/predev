...
class vshop_export_statement
{
    ...
    {
        $mdl_statement = app::get('vshop')->model('statement');
        ...
        $statement_index = app::get('vshop')->model('statement_index')->getList('*', array('statement_id' => $statement_id_arr));
        $exporter = new vshop_export_excel('browser', 'statement-'.date('YmdHis').'.xls');
        $exporter->initialize();
