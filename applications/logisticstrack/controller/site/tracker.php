...
class logisticstrack_ctl_site_tracker extends b2c_frontpage
{
    ...
    public function index($order_id)
    {
        ...
        if ($this->_request->is_ajax()) {
            ...
            $this->page('site/tracker/index.html');
        }
    } //End Function
} //End Class
