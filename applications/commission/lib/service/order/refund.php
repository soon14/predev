...
// +----------------------------------------------------------------------
class commission_service_order_refund
{
    ...
    */
    private function  _products_count($order_items, &$msg)
    {
        ...
        $sql = "UPDATE {$tb_prefix}products_count SET  commission_total= case product_id ";
        foreach ($order_items as $k => $v) {
            $sql .= sprintf("WHEN %d THEN commission_total-%f ", $v['product_id'], $v['product_fund']);
        }
