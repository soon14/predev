...
class solr_pinyin_Pinyin
{
     ...
     * Dict loader.
     *
     * @var solr_pinyin_DictLoaderInterface
     */
    protected $loader;
     ...
     * Constructor.
     *
     * @param solr_pinyin_DictLoaderInterface $loader
     */
    public function __construct(solr_pinyin_DictLoaderInterface $loader = null)
    {
        $this->loader = $loader;
    }
     ...
     * @return $this
     */
    public function setLoader(solr_pinyin_DictLoaderInterface $loader)
    {
        $this->loader = $loader;
     ...
     * Return dict loader,.
     *
     * @return solr_pinyin_DictLoaderInterface
     */
    public function getLoader()
    {
        if (!($this->loader instanceof solr_pinyin_DictLoaderInterface)) {
            $this->loader = new solr_pinyin_FileDictLoader(dirname(__FILE__).'/data/');
        }
     ...
     *
     * @param string                               $string
     * @param solr_pinyin_DictLoaderInterface $dictLoader
     *
     * @return string
     */
