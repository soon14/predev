...
class integralexchange_ctl_site_exchange extends b2c_ctl_site_member
{
    public $title = '积分兑换';
    ...
    public function exchange_coupon($coupon_id){
        if($coupon_id){
            $redirect_here = array('app' => 'integralexchange','ctl' => 'site_exchange','act' => 'exchange_coupon');
            $redirect_mycoupon = array('app' => 'b2c','ctl' => 'site_member','act' => 'coupon');
