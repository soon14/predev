...
class importexport_policy_FTPClient_FTPClient implements importexport_policy_FTPClient_FTPClientInterface,
                                          importexport_policy_FTPClient_ObservableInterface
{
	/** @var resource */
