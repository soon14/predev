...
class vmcconnect_object_api_input_jd_goods extends vmcconnect_object_api_input_jd_base {
    
    protected $marketables = array(
        'offsale' => false,
        'onsale' => true,
    );
    ...
    public function write_add() {
        ...
        isset($params['marketable']) && in_array($params['marketable'], array_keys($this->marketables)) && $params['marketable'] = $this->marketables[$params['marketable']];
        return $params;
    }
